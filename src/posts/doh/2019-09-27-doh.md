...
**BONUS**: You can give unbound a list of domains which it should resolve to "127.0.0.1", effectively blocking it. This is the basis for DNS based adblocking, and I've set it up here as well!
...
Not only am I able to control my own DNS resolver for all my devices now, at home and on the road. But I'm also able to offer some goodies such as adblocking ;) 
